...
public class OfferTestSamples {
    ...
    public static Offer getOfferSample1() {
        return new Offer().id(1L).title("title1").description("description1").rewardPoints(1).itemQty(1).itemSku("itemSku1");
    }

    public static Offer getOfferSample2() {
        return new Offer().id(2L).title("title2").description("description2").rewardPoints(2).itemQty(2).itemSku("itemSku2");
    }
    ...
    public static Offer getOfferRandomSampleGenerator() {
        return new Offer()
            ...
            .itemQty(intCount.incrementAndGet())

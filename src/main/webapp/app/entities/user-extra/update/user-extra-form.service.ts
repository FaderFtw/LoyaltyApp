...
type UserExtraFormGroupContent = {
  ...
  totalBalance: FormControl<IUserExtra['totalBalance']>;
  actualBalance: FormControl<IUserExtra['actualBalance']>;
...
export class UserExtraFormService {
  createUserExtraFormGroup(userExtra: UserExtraFormGroupInput = { id: null }): UserExtraFormGroup {
    ...
    return new FormGroup<UserExtraFormGroupContent>({
      ...
      totalBalance: new FormControl(userExtraRawValue.totalBalance, {
        validators: [Validators.required],
      }),
      actualBalance: new FormControl(userExtraRawValue.actualBalance, {
        validators: [Validators.required],
      }),
